...
// *************************** НАСТРОЙКИ ***************************
#define DAWN_TIME 25      // продолжительность рассвета (в минутах)
#define ALARM_TIMEOUT 100  // таймаут на автоотключение будильника, секунды
#define ALARM_BLINK 1     // 1 - мигать лампой при будильнике, 0 - не мигать
...
#define DAWN_MAX 250      // максимальная яркость лампы (0 - 255)
